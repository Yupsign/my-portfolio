  ...
  return (
    <div className="qna component__space" id="QnA">
      <div className="heading">
        ...
        <p className="heading a__text">
          "react v5에서 v6로 업데이트 되면서, 'react-router-dom'의 Switch부분이 삭제되고 대신 Routes로 바뀌었는데 바뀐줄 모르고 한참을 헤맸던 기억이 있습니다.<br></br>
          다운그레이드로 문제는 해결하였지만 빠르게 변화하는 기술에 대해서 앞으로 미리미리 알아보는 습관을 가져야겠다는 생각을 하였습니다."   
        </p>
        <p className="heading q__text">
        ...
        <p className="heading a__text">
          "저의 손 끝에서 하나의 프로그램이 완성되고, 이를 많은 사람들이 보다 편리한 삶을 누리는 모습이 제게 또 다른 영감을 주기 때문입니다.<br></br>
            그리고 무엇보다 제가 '대단한 개발자'라고는 할 수 없지만, 누구보다 개발에 흥미를 느끼고 그에 알맞는 열정을 가지고있습니다."
        </p>
      </div>
    </div>
  );
